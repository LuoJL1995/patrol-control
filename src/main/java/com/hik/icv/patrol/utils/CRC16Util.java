...
public class CRC16Util {
     ...
     * 计算CRC16校验  对外的接口
     *
     * @param data 需要计算的16进制的字符串
     * @return CRC16校验值
     */
    public static int calcCrc16(String data) {
        byte[] checkConent = ByteUtil.hexStringToBytes(data);//C40B
        return calcCrc16(checkConent);
    }
    /**
     * 计算CRC16校验  对外的接口
     *
     * @param data 需要计算的16进制的字符串
     * @return CRC16校验值 （16进制的字符串）
     */
    public static String calcCrc16String(String data){
        int i = calcCrc16(data);
        return CRC16Util.getCrc(i);
    }
